...
function Product() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <div className="text-black text-sm mb-2">
            ...
            120Hz, 16GB RAM, 512GB SSD, CNC Aluminum, Chroma RGB, Thunderbolt 4
          </div>
          {/* Product Title */}
          ...
          {/* Price */}
          <div className="mt-4">
            <span className="text-red-600 text-xl line-through">$1,499.00</span>
        ...
        {showDescription ? (
          <div>
            ...
            {/* <p className="text-gray-700 mt-2">
              ...
              orci. In et nunc consequat, semper.
            </p> */}
            ...
            {/* <div className="mt-4 bg-gray-200 p-4 rounded-lg">
              ...
              <p className="mt-2 text-black">
                Nunc sed justo. Cras vehicula semper ex, et fermentum tortor
                varius eget interdum et malesuada fames ac ante tellus eget.
              </p>
            </div> */}
          </div>
        ) : (
      ...
      <h2 className="text-2xl font-semibold text-black mb-6">Related products</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="p-4 rounded-lg">
          ...
          />
          <h3 className="text-lg font-semibold text-black">14'' FHD Ultrabook</h3>
        ...
        <div className=" p-4 rounded-lg">
          <Image
            ...
            className="w-full h-48 object-cover rounded-lg mb-4"
          />
          <h3 className="text-lg font-semibold text-black">15.6'' Rugged Ultrabook</h3>
          <p className="text-gray-700 text-sm mb-2">
            4K UHD - 3840 x 2160 - Intel Core i7 11th Gen, 32GB RAM, 1TB SSD - Carbon Gray
          </p>
        ...
        <div className=" p-4 rounded-lg relative">
          ...
          <h3 className="text-lg font-semibold text-black">15.6'' FHD Display Laptop</h3>
          <p className="text-gray-700 text-sm mb-2">
            Intel i7, Intel HD Graphics 6000, Webcam, WiFi, Bluetooth, HDMI, Windows 11, Grey
          </p>
