...
const AirConditioner: React.FC = () => {
  ...
  return (
    <div className="flex flex-col ml-8 mr-4">
      <h1 className="text-4xl text-[#F5ED4D] font-bold">PCs & LAPTOP</h1>
      <p className='py-8'>
        ...
        {products.map(product => (
          ...
          <div key={product._id} className="flex flex-wrap w-[300px] ">
            ...
            <div className="mx-6 my-4">
              <h2 className="text-2xl font-bold mt-2">13 Ultrabook Gaming Laptop: Intel Core i7-1165G7 4 Core, NVIDIA GeForce GTX 1650 Ti Max-Q, 13.3″ 1080p 120Hz, 16GB RAM, 512GB SSD, CNC Aluminum, Chroma RGB, Thunderbolt 4
              </h2>
              <div className="mt-4">
