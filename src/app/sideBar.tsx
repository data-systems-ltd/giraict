    ...
    return (
        <aside className="sidebar w-60 h-full border-b border-gray-300 md:border-b-0 md:border-r">
            ...
            <ul className="space-y-2 p-12">
                <li><Link href="/(content)/aircondition">Air Conditioner</Link></li>
                <li><Link href="/(content)/audio&video">Audio & Video</Link></li>
                <li><Link href="/(content)/gadgets">Gadgets</Link></li>
                ...
                <li><Link href="/(content)/phone">Smart Home</Link></li>
            </ul>
