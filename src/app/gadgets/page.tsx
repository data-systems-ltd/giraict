...
const AirConditioner: React.FC = () => {
  ...
  return (
    <div className="flex flex-col ml-8 mr-4">
      <h1 className="text-4xl text-[#F5ED4D] font-bold">Gadgets</h1>
      <p className='py-8'>
        ...
        {products.map(product => (
          ...
          <div key={product._id} className="flex flex-wrap w-[300px] ">
            ...
            <div className="mx-6 my-4">
              <h2 className="text-2xl font-bold mt-2">Air Conditioner 5000 BTU, Efficient Cooling for Smaller Areas Like Bedrooms and Guest Rooms4K Digital Camera, 12-32mm and 45-150mm Lens Bundle, 16 Megapixel Kit, 5 Axis In-Body Dual Image Stabilization, Black
              </h2>
              <div className="mt-4">
